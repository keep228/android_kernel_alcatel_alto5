...
/* [PLATFORM]-Mod-BEGIN by TCTNB.FLF, PR-829665, 2014/11/12, fix capacity drops after charging full */
#ifdef CONFIG_TCT_8X16_COMMON
/* [PLATFORM]-Add-BEGIN by TCTNB.FLF, PR-874286, 2014/12/16, power supply change */
...
/* [PLATFORM]-Mod-BEGIN by TCTNB.FLF, PR-868154, 2015/01/03, change ibat_max to 700 mA according to HW */
#ifdef CONFIG_TCT_8X16_ALTO4
#undef QPNP_LBC_IBATMAX_MAX
#define QPNP_LBC_IBATMAX_MAX	700
#endif
/* [PLATFORM]-Mod-END by TCTNB.FLF */
...
/*Add by TCTNB.THW, 2014/10/31,PR-807490, PR-836586, Charge LED*/
#if (defined CONFIG_TCT_8X16_ALTO5) || (defined CONFIG_TCT_8X16_ALTO5_PREMIUM) || (defined CONFIG_TCT_8X16_ALTO4)
void qnnp_lbc_enable_led(enum led_brightness value)
{
	u8 reg;
	int rc;
	...
	rc = qpnp_lbc_masked_write(ref_chip, ref_chip->chgr_base + LBC_CHGR_LED,
...
/* [PLATFORM]-Add-BEGIN by TCTNB.FLF, PR-861811, 2014/12/12, enable charge led node */
	chip->led_cdev.name = "led_G";
...
/* [PLATFORM]-Add-BEGIN by TCTNB.YuBin, 2014/12/24, read battery id for qpnp-adc-common.c */
#if defined(CONFIG_TCT_8X16_ALTO4)
static int64_t battery_id_for_qpnp_adc_common;
int64_t function_battery_id_for_qpnp_adc_common(void)
{
	return battery_id_for_qpnp_adc_common;
}
EXPORT_SYMBOL(function_battery_id_for_qpnp_adc_common);
#endif
...
/* [PLATFORM]-Add-BEGIN by TCTNB.YuBin, 2014/12/24, read battery id for qpnp-adc-common.c */
#if defined(CONFIG_TCT_8X16_ALTO4)
	battery_id_for_qpnp_adc_common = read_battery_id(chip);
#endif
/* [PLATFORM]-Add-END by TCTNB.YuBin */
