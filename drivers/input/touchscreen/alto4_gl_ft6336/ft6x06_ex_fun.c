...
/*xingchenwang 2015/1/5 update new firmware version = 0x18*/
...
//	#include "firmware/mutto4GL/ALTO4GL_MD53_V17_6336_20141203_app.h"
//	#include "firmware/mutto4GL/ALTO4GL_MD53_V18_6336_20141225_app.h"
	#include "firmware/mutto4GL/ALTO4GL_MD53_V1A_6336_20150129_app.h"
};
...
int fts_ctpm_auto_upgrade(struct i2c_client *client)
{
	...
	int i,i_ret = -1;
/*tianhongwei 2014/11/03 update new firmwarw version = 0x14*/
/*modify [BEGIN] wangxingchen PR.875082 1/5/2015*/
#if defined(CONFIG_TCT_8X16_ALTO4)
    unsigned char version_list[] = {0x00,0x10,0x14,0x17,0x18,0x19};
/*modify [END] wangxingchen PR.875082 1/5/2015*/
#elif defined(CONFIG_TCT_8X16_ALTO4NA)
    ...
    printk(KERN_INFO "%s uc_tp_fm_ver = 0x%x uc_host_fm_ver = 0x%x \n",__func__,uc_tp_fm_ver,uc_host_fm_ver);
        ...
        if(i == sizeof(version_list)/sizeof(version_list[0]))
            printk(KERN_INFO " it not need to upgrade to new version!");
	return 0;
}
