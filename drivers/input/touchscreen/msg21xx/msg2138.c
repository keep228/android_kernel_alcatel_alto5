...
/*[PLATFORM]-Add-BEGIN by TCTNB.ZXZ, PR944684 2015/03/10,phone may have I2C error can cause phone crash when update firmware */
#if 0
...
#if defined(CONFIG_TCT_8X16_ALTO4)
/*modify (add) wangxingchen for PR 884993 02/10/2015*/
	unsigned short version_list[] = {0x00,0x01,0x02,0x03,0x04,0x05,0x06};	//Keep the old version (minor) list that allows to be updated.
#elif defined(CONFIG_TCT_8X16_ALTO4NA)
    ...
    unsigned char version_list[] = {0x00,0x01};  //Keep the old version (minor) list that allows to be updated.
#elif defined(CONFIG_TCT_8X16_ALTO5)
    unsigned char version_list[] = {0x00,0x01,0x02,0x03,0x04,0x05,0x06,0x07,0x08,0x09};  //Keep the old version (minor) list that allows to be updated.//zxz
#else
