...
//[PLATFORM]-Add-BEGIN by TCTNB.ZXZ, FR-813918 2014/11/27,make double click in the same path
static DEVICE_ATTR(tp_gesture_id, SYSFS_AUTHORITY, DrvMainFirmwareGestureWakeupModeShow, DrvMainFirmwareGestureWakeupModeStore);
