 ...
 */
 /*FR846772 TCTNB.ZXZ ,2015/01/14 MSG26XXM_SW_ID_0001 is add for major version, sometimes factory
 download an error major version firmware( like 0001002) , it also should be update */
typedef enum {
    MSG26XXM_SW_ID_0001 = 0x0001,
