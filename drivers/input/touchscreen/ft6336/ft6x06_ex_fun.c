...
static unsigned char CTPM_FW[] = {
	#include "firmware/junda5GL/Alto5GL_JD85_V11_6436L_20141224_app.h"
};
#else
static unsigned char CTPM_FW[] = {
	#include "firmware/junda4EVDO/ALTO4_JD85_V10_6336_20140819_app.h"
...
/*tianhongwei 2014/11/03 update new firmwarw version = 0x14*/
#if defined(CONFIG_TCT_8X16_ALTO4)
    unsigned char version_list[] = {0x10,0x14};
#elif defined(CONFIG_TCT_8X16_ALTO4NA)
    unsigned char version_list[] = {};  
#elif defined(CONFIG_TCT_8X16_ALTO4EVDO)
    unsigned char version_list[] = {};  
/*wangxingchen 2015/1/12 update new firmware version = 0x11*/
#elif defined(CONFIG_TCT_8X16_ALTO5)
    unsigned char version_list[] = {0x00, 0x10};
#else
    unsigned char version_list[] = {};  
#endif
