...
//zxz add for FT6336 TP usb detect 2014/12/05
#ifdef CONFIG_FT6336_TOUCHPANEL_USB_DETECT
extern void  ft6x06_enable_change_scanning_frq(void);
extern void ft6x06_disable_change_scanning_frq(void);
#endif
...
//zxz add for FT6336 TP usb detect 2014/12/05
		#ifdef CONFIG_FT6336_TOUCHPANEL_USB_DETECT
			ft6x06_enable_change_scanning_frq();
		#endif
...
//zxz add for FT6336 TP usb detect 2014/12/05
			...
			ft6x06_disable_change_scanning_frq();
		#endif
	}
